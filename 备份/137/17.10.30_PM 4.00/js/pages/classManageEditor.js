...
/***/ function(module, exports, __webpack_require__) {
	...
	getStudyResourceMsg = host + 'getStudyResourceMsg',
	    // 获取微视频
	uploadResourceLinkURL = host + 'uploadResourceLink',
	    // 获取参考资源URL
			...
			if (meta.result == 100) {
				...
				switch (ajaxName) {
					...
					case '微视频':
						...
						videos.push([{ value: data[0].originName }, { value: '删除', fileName: data[0].fileName, callback: deleteFile }, { value: '下载', downloadName: data[0].originName, fileName: data[0].fileName, callback: downloadFile }]);
						that.setState({
							videos: videos,
							isUpload: true
						});
			...
			switch (moduleName) {
				...
				case '考核方案':
					...
					for (i = 0, len = list.length; i < len; i++) {
						items[i] = [{ value: list[i].originName }, { value: '删除', fileName: list[i].fileName, callback: deleteFile }, { value: '下载', downloadName: list[i].originName, fileName: list[i].fileName, callback: downloadFile }];
					}
					that.items = items;
					that.isUpload = true;
					break;
					...
					ajaxPading.send({
						...
						onSuccess: function onSuccess(result) {
							...
							if (meta.result == 100) {
								...
								for (i = 0, len = data.length; i < len; i++) {
									if (data[i].wlxxzylj == "") {
										videos.push([{ value: data[i].ywjm }, { value: '删除', fileName: data[i].xywjm, callback: deleteFile }, { value: '下载', downloadName: data[i].ywjm, fileName: data[i].xywjm, callback: downloadFile }]);
									} else {
										otherVideo.push([{
											value: data[i].ljmc,
											url: data[i].wlxxzylj
					...
					if (meta.result == 100) {
						...
						for (i = 0, len = data.length; i < len; i++) {
							...
							if (data[i].wlxxzylj == "") {
								...
								if (value == '微视频') {
									localResourse.push([{ value: data[i].ywjm }, { value: '删除', callback: deleteFile, fileName: data[i].xywjm }, { value: '下载', downloadName: data[i].ywjm, fileName: data[i].xywjm, callback: downloadFile }]);
								} else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BluMUI_StudySource = function (_React$Component8) {
		_inherits(BluMUI_StudySource, _React$Component8);

		function BluMUI_StudySource(props) {
			_classCallCheck(this, BluMUI_StudySource);

			var _this11 = _possibleConstructorReturn(this, (BluMUI_StudySource.__proto__ || Object.getPrototypeOf(BluMUI_StudySource)).call(this, props));

			_this11.state = {
				isDown: true,
				fileName: '',
				bookType: '',
				otherVideo: _this11.props.otherVideo,
				sourceType: _this11.props.title,
				jcBooks: _this11.props.jcBooks,
				ckBooks: _this11.props.ckBooks,
				onlineSource: _this11.props.onlineSource,
				onlineURL: _this11.props.onlineURL,
				videos: _this11.props.videos,
				jyFile: _this11.props.jyFile,
				jyAttachment: _this11.props.jyAttachment,
				hkFile: _this11.props.hkFile,
				xtFile: _this11.props.xtFile,
				isUpload: true,
				isUpload1: true,
				addBox: false
			};
			_this11._isDown = _this11._isDown.bind(_this11);
			_this11._uploadPic = _this11._uploadPic.bind(_this11);
			_this11._delete = _this11._delete.bind(_this11);
			_this11._add = _this11._add.bind(_this11);
			_this11._sure = _this11._sure.bind(_this11);
			_this11._off = _this11._off.bind(_this11);
			_this11._save = _this11._save.bind(_this11);
			return _this11;
		}
							...
							_react2["default"].createElement(
								...
								_react2["default"].createElement(
									...
									_react2["default"].createElement(
										...
										{ className: 'fileArea' },
										_react2["default"].createElement('img', { className: 'fileInput', ref: function ref(img) {
												return _this12.img = img;
											}, src: '../../imgs/home-course/default.png' })
									),
									_react2["default"].createElement(
										'span',
										{ className: 'fileUp activeBtn' },
								...
								_react2["default"].createElement(
									...
									_react2["default"].createElement('input', { type: 'text', ref: function ref(bookName) {
											return _this12.bookName = bookName;
										} }),
	...
	var BluMUI_CourseStatus = function (_React$Component9) {
		_inherits(BluMUI_CourseStatus, _React$Component9);
