...
/***/ function(module, exports, __webpack_require__) {
						...
						_react2["default"].createElement(
							...
							this.props.userList.map(function (text, i) {
								return _react2["default"].createElement(
									'li',
									{ key: i, className: 'func', onClick: _this2._noShow(text) },
									text
								);
							})
						)
	...
	var BluMUI_List = function (_React$Component2) {
		...
		function BluMUI_List(props) {
			...
			var _this3 = _possibleConstructorReturn(this, (BluMUI_List.__proto__ || Object.getPrototypeOf(BluMUI_List)).call(this, props));
	...
	var BluMUI_TeachPlan = function (_React$Component3) {
		_inherits(BluMUI_TeachPlan, _React$Component3);

		function BluMUI_TeachPlan(props) {
			_classCallCheck(this, BluMUI_TeachPlan);

			return _possibleConstructorReturn(this, (BluMUI_TeachPlan.__proto__ || Object.getPrototypeOf(BluMUI_TeachPlan)).call(this, props));
		}

		_createClass(BluMUI_TeachPlan, [{
			key: '_create',
			...
			value: function render() {
				return _react2["default"].createElement(
					'div',
					{ className: 'BluMUI_TeachPlan' },
					this._create(this.props.items)
				);
			}
		}]);

		return BluMUI_TeachPlan;
	}(_react2["default"].Component);
