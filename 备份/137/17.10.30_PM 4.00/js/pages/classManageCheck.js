...
/***/ function(module, exports, __webpack_require__) {
	...
	var BluMUI = __webpack_require__(7),
		...
		'电子教案': '../classInfShow/classCheckModule.html?classId=' + classId + '&moduleName=' + encodeURIComponent('电子教案'),
		'考试大纲': '../classInfShow/classCheckModule.html?classId=' + classId + '&moduleName=' + encodeURIComponent('考试大纲'),
		'考核方案': '../classInfShow/classCheckModule.html?classId=' + classId + '&moduleName=' + encodeURIComponent('考核方案'),
		'教学大纲': '../classInfShow/classCheckModule.html?classId=' + classId + '&moduleName=' + encodeURIComponent('教学大纲'),
		'导学方案': '../classInfShow/classCheckModule.html?classId=' + classId + '&moduleName=' + encodeURIComponent('导学方案'),
		'授课计划': '../classInfShow/classCheckModule.html?classId=' + classId,
		'实习计划': '../classInfShow/classCheckModule.html?classId=' + classId,
		'知识点体系': '../classInfShow/classCheckModule.html?classId=' + classId + '&moduleName=' + encodeURIComponent('知识体系'),
	...
	ajaxPading.send({
		...
		onSuccess: function onSuccess(result) {
			...
			if (meta.result == 100) {
				...
				if (type === 1) courseType = 7;
				if (type === 2) courseType = 8;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BluMUI_UserLoginState = function (_React$Component) {
		_inherits(BluMUI_UserLoginState, _React$Component);

		function BluMUI_UserLoginState(props) {
			_classCallCheck(this, BluMUI_UserLoginState);

			var _this = _possibleConstructorReturn(this, (BluMUI_UserLoginState.__proto__ || Object.getPrototypeOf(BluMUI_UserLoginState)).call(this, props));
			...
			_this._noShow = _this._noShow.bind(_this);
			return _this;
		}
			...
			value: function _createFunc() {
				if (this.props.isLogin) {
					...
					for (i = 0, len = funcMoulde.length; i <= len; i++) {
						if (i == 0) result.push(_react2["default"].createElement('hr', { key: i }));else result.push(_react2["default"].createElement(
							'li',
							{ key: i, onClick: this._onClick },
							funcMoulde[i - 1]
						));
					}
				}
			...
			value: function _isLogin() {
				...
				if (this.props.isLogin) {
						...
						_react2["default"].createElement(
							...
							this.props.userList.map(function (text, i) {
								return _react2["default"].createElement(
									'li',
									{ key: i, className: 'func', onClick: _this2._noShow },
									text
								);
							})
						)
					...
					var result = _react2["default"].createElement(
						...
						_react2["default"].createElement(
							'span',
							{ className: 'login', onClick: this._onClick },
							'\u767B\u5F55'
						),
						_react2["default"].createElement(
							'span',
			...
			value: function render() {
				return _react2["default"].createElement(
					...
					_react2["default"].createElement(
						'div',
						null,
						_react2["default"].createElement('span', { className: 'userOther' }),
						this._isLogin()
					),
					_react2["default"].createElement(
						'ul',
	...
	var BlueMUI_Radio = function (_React$Component2) {
		_inherits(BlueMUI_Radio, _React$Component2);

		function BlueMUI_Radio(props) {
			_classCallCheck(this, BlueMUI_Radio);

			var _this3 = _possibleConstructorReturn(this, (BlueMUI_Radio.__proto__ || Object.getPrototypeOf(BlueMUI_Radio)).call(this, props));
		...
		_createClass(BlueMUI_Radio, [{
			...
			value: function render() {
				return _react2["default"].createElement(
					'div',
					{ className: 'BlueMUI_Radio radio' + this.props.index },
	...
	var BlueMUI_MouduleCheck = function (_React$Component3) {
		_inherits(BlueMUI_MouduleCheck, _React$Component3);

		function BlueMUI_MouduleCheck(props) {
			_classCallCheck(this, BlueMUI_MouduleCheck);

			var _this4 = _possibleConstructorReturn(this, (BlueMUI_MouduleCheck.__proto__ || Object.getPrototypeOf(BlueMUI_MouduleCheck)).call(this, props));

			_this4._Click = _this4._Click.bind(_this4);
			var i,
			    len,
			    selectArray = [];
			for (i = 0, len = _this4.props.modules.length; i < len; i++) {
		...
		_createClass(BlueMUI_MouduleCheck, [{
			key: '_Click',
			value: function _Click(select, index, type) {
			...
			key: '_createRadios',
			value: function _createRadios(radios, index) {
				var i,
				    len,
				    result = [];
				for (i = 0, len = radios.length; i < len; i++) {
					result.push(_react2["default"].createElement(BlueMUI_Radio, { name: radios[i],
						key: i,
						index: i,
						type: index,
			...
			value: function render() {
				return _react2["default"].createElement(
					'div',
					{ className: 'BlueMUI_MouduleCheck' },
					this.props.isCheck && _react2["default"].createElement(
						'div',
						{ className: 'Warp' },
						_react2["default"].createElement(
							'span',
		...
		return BlueMUI_MouduleCheck;
	}(_react2["default"].Component);

	var BluMUI_NavList = function (_React$Component4) {
		_inherits(BluMUI_NavList, _React$Component4);

		function BluMUI_NavList(props) {
			_classCallCheck(this, BluMUI_NavList);

			var _this5 = _possibleConstructorReturn(this, (BluMUI_NavList.__proto__ || Object.getPrototypeOf(BluMUI_NavList)).call(this, props));

			_this5.state = {
				items: _this5.props.items,
				index: _this5.props.index
			};
			_this5._onClick = _this5._onClick.bind(_this5);
			return _this5;
		}
	...
	var BluMuI_FileNum = function (_React$Component5) {
		_inherits(BluMuI_FileNum, _React$Component5);

		function BluMuI_FileNum(props) {
			_classCallCheck(this, BluMuI_FileNum);

			return _possibleConstructorReturn(this, (BluMuI_FileNum.__proto__ || Object.getPrototypeOf(BluMuI_FileNum)).call(this, props));
		}

		_createClass(BluMuI_FileNum, [{
			key: '_createFileShow',
			value: function _createFileShow(items) {
				var i,
				    len,
				    result = [];
			...
			value: function render() {
				...
				return _react2["default"].createElement(
					...
					_react2["default"].createElement(
						'ul',
						null,
						this._createFileShow(items)
					)
				);
			}
		}]);

		return BluMuI_FileNum;
	}(_react2["default"].Component);

	var BluMUI_M = {
		UserLoginState: BluMUI_UserLoginState,
		NavList: BluMUI_NavList,
		FileNum: BluMuI_FileNum,
