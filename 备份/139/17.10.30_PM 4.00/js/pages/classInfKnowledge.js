...
/***/ function(module, exports, __webpack_require__) {
	...
	var BluMUI_DropList_box = function (_React$Component) {
		_inherits(BluMUI_DropList_box, _React$Component);

		function BluMUI_DropList_box(props) {
			_classCallCheck(this, BluMUI_DropList_box);

			var _this = _possibleConstructorReturn(this, (BluMUI_DropList_box.__proto__ || Object.getPrototypeOf(BluMUI_DropList_box)).call(this, props));
			...
			value: function render() {
				...
				var result = this.props.items.map(function (value, index) {
					return _react2["default"].createElement(
						'ul',
						{ key: index,
							className: _this2.props.curClass + '-' + index },
						_react2["default"].createElement(
							...
							_react2["default"].createElement(
								...
								{ onClick: _this2.handlerClick,
									'data-key': index,
									className: "item_warp " + items[index].nameStyle + ' ' + _this2.state.selectedClass[index][_this2.state.selects[index]] },
								_react2["default"].createElement(
									'span',
									{ 'data-key': index,
										className: 'leftLogo',
										style: _this2.state.leftLogo[index][_this2.state.selects[index]] },
								...
								_react2["default"].createElement('span', { 'data-key': index,
									className: 'rightLogo',
									style: _this2.state.rightLogo[index][_this2.state.selects[index]] })
							),
							items[index].items.length > 0 && _react2["default"].createElement(BluMUI_DropList_box, {
								callBack: callBack,
								curClass: curClass + '-' + index,
								curstyle: _this2.state.style[_this2.state.selects[index]],
	...
	var BluMUI_DropList = function (_React$Component2) {
		_inherits(BluMUI_DropList, _React$Component2);
