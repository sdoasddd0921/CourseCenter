...
/***/ function(module, exports, __webpack_require__) {
	...
	BluMUI.create({
		...
		{
			src: "#", //点击后打开新窗口进入地址
			img: "imgs/home/2-font.png" // 轮播图图片路径
		}, {
			src: "#",
			img: "imgs/home/3-font.png"
		}, {
			src: "#",
			img: "imgs/home/1-font.png"
		}]
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flexibleAnimationReact = __webpack_require__(165);

	var _flexibleAnimationReact2 = _interopRequireDefault(_flexibleAnimationReact);
	...
	var BluMUI_Carousel = function (_React$Component) {
		_inherits(BluMUI_Carousel, _React$Component);

		function BluMUI_Carousel(props) {
			_classCallCheck(this, BluMUI_Carousel);

			var _this = _possibleConstructorReturn(this, (BluMUI_Carousel.__proto__ || Object.getPrototypeOf(BluMUI_Carousel)).call(this, props));

			_this.clickNav = _this.clickNav.bind(_this);
			_this.clickNext = _this.clickNext.bind(_this);
			_this.clickLast = _this.clickLast.bind(_this);
			_this.changIndex = _this.changIndex.bind(_this);
			_this.carouselAnimation = _this.carouselAnimation.bind(_this);
			_this.mouseOffHandel = _this.mouseOffHandel.bind(_this);
			_this.mouseOverHandel = _this.mouseOverHandel.bind(_this);
			_this.state = {
				index: _this.props.index,
				left: -1 * _this.props.index * _this.props.width,
				animation: false,
				mouse: false
			};
			return _this;
		...
		_createClass(BluMUI_Carousel, [{
			...
			value: function carouselAnimation(dis) {
				...
				setTimeout(function () {
					...
					_flexibleAnimationReact2["default"].init({
					...
					_flexibleAnimationReact2["default"].star(that, 'myAnimation');
				}, 200);
			}
		}, {
			key: 'changIndex',
				...
				return _react2["default"].createElement(
					...
					_react2["default"].createElement(
						...
						_react2["default"].createElement(
							'ul',
							{ className: 'control' },
							_react2["default"].createElement('button', { onClick: this.clickLast,
								className: 'last' }),
							_react2["default"].createElement(
								'ul',
								{ className: 'showNav' },
							...
							_react2["default"].createElement('button', { onClick: this.clickNext,
								className: 'next' })
						)
					)
				);
...
/***/ function(module, exports) {
	...
	(function () {
		...
		if (!window.requestAnimationFrame) window.requestAnimationFrame = function (func) {
	...
	var speedPattern = function speedPattern() {
	...
	var flexibleAniamtion = {
		aniamtion: [],
		init: function init(startInf, animationName) {
			// 设置动画的初始值
		...
		star: function star(that, animationName) {
