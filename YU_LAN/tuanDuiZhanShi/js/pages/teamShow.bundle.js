...
/***/ function(module, exports, __webpack_require__) {
	...
	var BluMUI_Fuzeren = function (_React$Component) {
	  _inherits(BluMUI_Fuzeren, _React$Component);

	  function BluMUI_Fuzeren(props) {
	    _classCallCheck(this, BluMUI_Fuzeren);

	    return _possibleConstructorReturn(this, (BluMUI_Fuzeren.__proto__ || Object.getPrototypeOf(BluMUI_Fuzeren)).call(this, props));
	    // this.create_fuzeren=this.create_fuzeren.bind(this);
	  }

	  _createClass(BluMUI_Fuzeren, [{
	    key: 'create_fuzeren',
	    value: function create_fuzeren() {
	      var fuzeren = [];
	      this.props.Fuzeren.map(function (e) {
	  ...
	  return BluMUI_Fuzeren;
	}(_react2["default"].Component);

	var BluMUI_Teachers = function (_React$Component2) {
	  _inherits(BluMUI_Teachers, _React$Component2);

	  function BluMUI_Teachers(props) {
	    _classCallCheck(this, BluMUI_Teachers);

	    return _possibleConstructorReturn(this, (BluMUI_Teachers.__proto__ || Object.getPrototypeOf(BluMUI_Teachers)).call(this, props));
	  }

	  _createClass(BluMUI_Teachers, [{
	    key: 'create_teachers',
	    value: function create_teachers() {
	      var teachers = [];
	      this.props.Teachers.map(function (e) {
	        teachers.push(_react2["default"].createElement(
	          'div',
	          { className: 'teachers', key: e.xm },
	          _react2["default"].createElement('img', { src: '../../imgs/team_show/teacher_s.png' }),
	    ...
	    value: function render() {
	      return _react2["default"].createElement(
	        'div',
	        { id: 'teachers' },
	        this.create_teachers()
	      );
	    }
	  }]);

	  return BluMUI_Teachers;
	}(_react2["default"].Component);
